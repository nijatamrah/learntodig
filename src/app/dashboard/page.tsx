...
const quickLinks = [
  { title: "Dərslər", desc: "Geologiya, Drilling, Rezervuar və daha çox", icon: "📚", color: "#FF6B2B", href: "/learn", tag: "5 mövzu" },
  ...
  { title: "Karyera Xəritəsi", desc: "Karyera yolları, vəzifələr, maaşlar", icon: "🏭", color: "#A78BFA", href: "/industry-map", tag: "Yeni" },
