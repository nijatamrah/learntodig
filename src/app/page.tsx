    ...
    <main className="bg-[#0A0F1E] text-[#F0F4FF] overflow-x-hidden">
            ...
            {[
              {
                n: "01",
                title: "Dərs seç",
                text: "Geologiya, Drilling, Quyu Loqları, Rezervuar ya Hasilat — maraqlandığın mövzudan başla",
              },
              {
                n: "02",
                title: "Oxu + Quizlər",
                text: "5 bölmə, hər bölmədən sonra quiz. Anlamadığını AI-dan sor",
              },
              {
                n: "03",
                title: "Praktika et",
                text: "Dərs bitəndə müvafiq modul açılır — öyrəndiyini real simulyatorda tətbiq et",
              },
            ].map((s, i) => (
              <div
                key={s.n}
                className={`px-6 py-8 text-center ${
                  i < 2 ? "md:border-r border-[rgba(255,255,255,0.06)]" : ""
                }`}
              >
                <div className="font-['Space_Grotesk'] text-[3rem] font-bold text-[rgba(0,212,255,0.15)] leading-none mb-3">
                  {s.n}
                </div>
      ...
      <section className="max-w-[1100px] mx-auto px-6 pb-24">
        <div className="bg-gradient-to-br from-[#1A2744] to-[#0F1A3A] border border-[rgba(0,212,255,0.2)] rounded-[20px] p-16 text-center">
          ...
          <p className="text-[#8B9DC3] mb-8 text-[1rem]">
            Qeydiyyat yoxdur, ödəniş yoxdur — sadəcə öyrən.
          </p>
          <Link href="/lessons">
