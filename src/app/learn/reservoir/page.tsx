...
const sections: Section[] = [
  {
    id: "4.1",
    title: "Reservoir Əsasları",
    lessons: [
      { id: "4.1.1", title: "Reservoir Fluidlərinə Giriş (PVT Əsasları)", slug: "intro-to-reservoir-fluids-pvt", done: false },
      { id: "4.1.2", title: "Reservoir Təzyiqi və Temperatur", slug: "reservoir-pressure-temperature", done: false },
    ],
  },
  {
    id: "4.2",
    title: "Həcm Hesablamaları",
    lessons: [
      { id: "4.2.1", title: "OOIP/OGIP Hesablamaları (Volumetric Method)", slug: "volumetric-method-ooip-ogip", done: false },
      { id: "4.2.2", title: "Material Balance Tənliyi", slug: "material-balance-equation", done: false },
    ],
  },
  {
    id: "4.3",
    title: "Axın Davranışı",
    lessons: [
      { id: "4.3.1", title: "Darcy Qanunu və Reservoir Axını", slug: "darcy-law-reservoir-flow", done: false },
      { id: "4.3.2", title: "Quyu Testi və Productivity Index", slug: "well-testing-productivity-index", done: false },
      { id: "4.3.3", title: "Relative Permeability və Flüid Doyma", slug: "relative-permeability-saturation", done: false },
    ],
  },
  {
    id: "4.4",
    title: "İstismar Dinamikası",
    lessons: [
      { id: "4.4.1", title: "Decline Curve Analizi", slug: "decline-curve-analysis", done: false },
      { id: "4.4.2", title: "Recovery Factor və Enhanced Oil Recovery (EOR)", slug: "recovery-factor-eor", done: false },
      { id: "4.4.3", title: "Reservoir Simulyasiyasına Giriş", slug: "intro-to-reservoir-simulation", done: false },
    ],
  },
];

export default function ReservoirPathPage() {
  const [openSection, setOpenSection] = useState<string | null>("4.1");
        ...
        <div className="mb-10 flex items-end justify-between">
          <div>
            ...
            <p className="text-[14px] font-['Space_Grotesk']" style={{ color: "#6B82A0" }}>
              Nə qədər var, necə hərəkət edir
            </p>
          </div>
                ...
                {isOpen && (
                  <div style={{ borderTop: `1px solid ${PATH_COLOR}22` }}>
                    {section.lessons.map((lesson) => (
                      <Link
                        key={lesson.id}
                        href={`/learn/reservoir/${lesson.slug}`}
