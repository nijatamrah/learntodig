...
const sections: Section[] = [
  {
    id: "3.1",
    title: "Logging Əsasları",
    lessons: [
      { id: "3.1.1", title: "Well Logging-ə Giriş", slug: "intro-to-well-logging", done: false },
      { id: "3.1.2", title: "Log Alətləri (Wireline vs LWD)", slug: "logging-tools-wireline-lwd", done: false },
    ],
  },
  {
    id: "3.2",
    title: "Əsas Log Növləri",
    lessons: [
      { id: "3.2.1", title: "Gamma Ray və Resistivity Logs", slug: "gamma-ray-resistivity-logs", done: false },
      { id: "3.2.2", title: "Density, Neutron və Sonic Logs", slug: "density-neutron-sonic-logs", done: false },
    ],
  },
  {
    id: "3.3",
    title: "Petrofizika Hesablamaları",
    lessons: [
      { id: "3.3.1", title: "Şist Həcmi və Effektiv Məsaməlilik", slug: "shale-volume-effective-porosity", done: false },
      { id: "3.3.2", title: "Su Doyma Dərəcəsi (Archie Tənliyi)", slug: "water-saturation-archie", done: false },
    ],
  },
  {
    id: "3.4",
    title: "İnterpretasiya və Tətbiq",
    lessons: [
      { id: "3.4.1", title: "Log Korrelyasiyası və Kollektor Qiymətləndirməsi", slug: "log-correlation-reservoir-evaluation", done: false },
    ],
  },
];

export default function WellLogPathPage() {
  const [openSection, setOpenSection] = useState<string | null>("3.1");
                ...
                {isOpen && (
                  <div style={{ borderTop: `1px solid ${PATH_COLOR}22` }}>
                    {section.lessons.map((lesson) => (
                      <Link
                        key={lesson.id}
                        href={`/learn/well-log/${lesson.slug}`}
