...
const FACTS = [
  ...
  "Drill bit — qazıma ucu — almaz materialdan hazırlanır.",
  "WOB (Weight on Bit) qazıma sürətinə birbaşa təsir edən əsas parametrdir.",
  "ROP (Rate of Penetration) saatda neçə metr qazıldığını göstərir.",
  "Mud logging qazıma zamanı çıxan süxur nümunələrini real vaxtda analiz edir.",
